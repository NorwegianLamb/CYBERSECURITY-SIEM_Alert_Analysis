...
function Load-Csv {
    ...
    $countryCodeMapping = @(
        ...
        @{ "name" = "Ã…land Islands"; "alpha-2" = "AX"; "country-code" = "248" },
        ...
        @{ "name" = "CÃ´te d'Ivoire"; "alpha-2" = "CI"; "country-code" = "384" },
        @{ "name" = "Croatia"; "alpha-2" = "HR"; "country-code" = "191" },
        @{ "name" = "Cuba"; "alpha-2" = "CU"; "country-code" = "192" },
        @{ "name" = "CuraÃ§ao"; "alpha-2" = "CW"; "country-code" = "531" },
        ...
        @{ "name" = "RÃ©union"; "alpha-2" = "RE"; "country-code" = "638" },
        ...
        @{ "name" = "Saint BarthÃ©lemy"; "alpha-2" = "BL"; "country-code" = "652" },
